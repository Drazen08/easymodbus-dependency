...
/* 37 */   public static ModbusServerRtuFactory getInstance() { return INSTANCE; }



   public ModbusServer4RtuSlave createServer4Slave(int port, ModbusRequestHandler handle) throws Exception {
/* 42 */     ModbusServer4RtuSlave modbusServer4Slave = new ModbusServer4RtuSlave(port);
...
/* 48 */     ModbusServer4RtuSlave modbusServer4Slave = new ModbusServer4RtuSlave(port);
...
/* 55 */     ModbusServer4RtuMaster modbusServer4Master = new ModbusServer4RtuMaster(port);
...
/* 62 */     ModbusServer4RtuMaster modbusServer4Master = new ModbusServer4RtuMaster(port);
