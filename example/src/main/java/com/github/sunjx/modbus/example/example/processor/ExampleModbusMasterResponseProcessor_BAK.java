...
public class ExampleModbusMasterResponseProcessor_BAK extends AbstractModbusProcessor implements ModbusMasterResponseProcessor {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(ExampleModbusMasterResponseProcessor_BAK.class);

    public ExampleModbusMasterResponseProcessor_BAK(short transactionIdentifierOffset) {
