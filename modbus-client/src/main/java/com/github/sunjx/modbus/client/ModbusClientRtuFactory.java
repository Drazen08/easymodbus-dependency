 ...
 public class ModbusClientRtuFactory
 {
   ...
   {
/* 33 */     private static final ModbusClientRtuFactory INSTANCE = new ModbusClientRtuFactory();
   }

/* 36 */   protected static final InternalLogger log = InternalLoggerFactory.getInstance(ModbusClientRtuFactory.class);


/* 39 */   public static ModbusClientRtuFactory getInstance() { return INSTANCE; }



/* 43 */   public ModbusClient4RtuSlave createClient4Slave(int port, ModbusRequestHandler handle) throws Exception { return createClient4Slave("127.0.0.1", port, handle); }



   public ModbusClient4RtuSlave createClient4Slave(String hotst, int port, ModbusRequestHandler handle) throws Exception {
/* 48 */     ModbusClient4RtuSlave modbusClient4Slave = new ModbusClient4RtuSlave(hotst, port);
...
/* 56 */     ModbusClient4RtuSlave modbusClient4Slave = new ModbusClient4RtuSlave(hotst, port);
/* 57 */     modbusClient4Slave.setup((ChannelInitializer<SocketChannel>)handle);
/* 58 */     return modbusClient4Slave;
   }


/* 62 */   public ModbusClient4RtuMaster createClient4Master(int port, ModbusResponseHandler handle) throws Exception { return createClient4Master("127.0.0.1", port, handle); }




   public ModbusClient4RtuMaster createClient4Master(String hotst, int port, ModbusResponseHandler handle) throws Exception {
/* 68 */     ModbusClient4RtuMaster modbusClient4Master = new ModbusClient4RtuMaster(hotst, port);
...
/* 77 */     ModbusClient4RtuMaster modbusClient4Master = new ModbusClient4RtuMaster(hotst, port);
...
/* Location:              D:\logs\easymodbus4j-client-0.0.5.jar!\com\github\zengfr\easymodbus4j\client\ModbusClientRtuFactory.class
