 ...
 {
/* 27 */   public ReadHoldingRegistersRequest() { super((short)3); }



/* 31 */   public ReadHoldingRegistersRequest(int startingAddress, int quantityOfInputRegisters) { super((short)3, startingAddress, quantityOfInputRegisters); }
...
/* 44 */   public String toString() { return "ReadHoldingRegistersRequest{startingAddress=" + this.address + ", quantityOfInputRegisters=" + this.value + '}'; }
 }
