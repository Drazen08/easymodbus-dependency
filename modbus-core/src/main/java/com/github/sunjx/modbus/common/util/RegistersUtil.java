...
public class RegistersUtil {
    public static int[] getRandomRegisters(int length, int minInt, int maxInt, Random random) {
        /*  26 */
        int[] registers = new int[length];
        /*  27 */
        for (int i = 0; i < registers.length; i++) {
            /*  28 */
            registers[i] = minInt + random.nextInt(maxInt);
        }
        /*  30 */
        return registers;
    }
    ...
    /*  41 */
    public static byte[] toByteArrayShort(short value) {
    ...
    /*  57 */
    public static byte[] toByteArrayFloat(float value) {
    ...
    public static double convertRegistersToDouble(int[] registers) throws IllegalArgumentException {
        ...
        /*  91 */
        byte[] doubleBytes = {highRegisterBytes[1], highRegisterBytes[0], highLowRegisterBytes[1], highLowRegisterBytes[0], lowHighRegisterBytes[1], lowHighRegisterBytes[0], lowRegisterBytes[1], lowRegisterBytes[0]};
    ...
    public static long convertRegistersToLong(int[] registers) throws IllegalArgumentException {
        ...
        byte[] lowRegisterBytes = toByteArray(registers[0]);
        /* 141 */
        byte[] longBytes = {highRegisterBytes[1], highRegisterBytes[0], highLowRegisterBytes[1], highLowRegisterBytes[0], lowHighRegisterBytes[1], lowHighRegisterBytes[0], lowRegisterBytes[1], lowRegisterBytes[0]};
    ...
    public static int[] convertFloatToRegisters(float floatValue) {
        /* 202 */
        byte[] floatBytes = toByteArrayFloat(floatValue);
        /* 203 */
    ...
    public static int[] convertLongToRegisters(long longValue) {
        ...
        /* 280 */
        int[] returnValue = {ByteBuffer.wrap(lowlowRegisterBytes).getInt(), ByteBuffer.wrap(lowHighRegisterBytes).getInt(), ByteBuffer.wrap(highlowRegisterBytes).getInt(), ByteBuffer.wrap(highhighRegisterBytes).getInt()};
        /* 281 */
        return returnValue;
    }
